...
class LanguageModel:
    ...
    def _get_denom(self, ngram):
        return self.ng_counter.total_tokens if self.ng_counter.n == 1 else self.ng_counter.context_counts[ngram[:-1]]
